...
<html lang="en">
  ...
  <head>
    ...
    <!-- Plugin CSS -->
    <link href="{{ asset('template/vendor/magnific-popup/magnific-popup.css') }}" rel="stylesheet">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Pemeringkatan DKP</a>
      ...
      <div class="container my-auto">
        <div class="row">
          ...
          <div class="col-lg-8 mx-auto">
            <p class="text-faded mb-5">Sistem pemeringkatan DKP setiap provinsi secara Nasional</p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto text-center">
            ...
            <hr class="light my-4">
            <p class="text-faded mb-4">Suatu sistem yang menginformasikan keadaan DKP di setiap provinsi dan mengetahui peringkat DKP yang memiliki pengelolaan pesisir terbaik.</p>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box mt-5 mx-auto">
              ...
              <h3 class="mb-3">Easily Accessible</h3>
    ...
    <section class="bg-dark text-white">
      <div class="container text-center">
        <h2 class="mb-4">Daftar DKP Provinsi</h2>
        <a class="btn btn-light btn-xl sr-button" href="{{ url('register') }}">Daftar Sekarang</a>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto text-center">
            ...
            <hr class="my-4">
            <p class="mb-5">Untuk informasi lebih lanjut, hubungi kami melalui</p>
          </div>
        </div>
        <div class="row">
